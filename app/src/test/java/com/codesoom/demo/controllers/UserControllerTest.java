...
class UserControllerTest {
    ...
    private static final String MY_TOKEN = "eyJhbGciOiJIUzI1NiJ9.eyJ1c2" +
    ...
    private static final String ADMIN_TOKEN = "eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjEwMDR9" +
            ".3GV5ZH3flBf0cnaXQCNNZlT4mgyFyBUhn3LKzQohh1A";
    ...
    void setUp() {
        ...
        given(authenticationService.roles(2L)).willReturn(Arrays.asList(new Role("USER")));
        given(authenticationService.roles(1004L)).willReturn(Arrays.asList(new Role("ADMIN")));
    ...
    @Test
    void updateUserWithValidAtrributes() throws Exception {
    ...
    @Test
    void updateUserWithInvalidAtrributes() throws Exception {
    ...
    @Test
    void updateUserOthersAccessToken() throws Exception {
    ...
    @Test
    void updateUserWithNoExistedId() throws Exception {
