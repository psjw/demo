...
class SessionControllerTest {
    ...
    void setUp() {
        ...
        given(authenticationService.login("badguy@example.com","test")).willThrow(new LoginFailException("badguy@example.com"));
        given(authenticationService.login("tester@example.com","badguy")).willThrow(new LoginFailException("badguy@example.com"));
    }
    ...
    void loginWithWrongPassword() throws Exception {
        ...
        mockMvc.perform(post("/session")
                .contentType(MediaType.APPLICATION_JSON)
                .content("{\"email\":\"tester@example.com\",\"password\" :\"badguy\"}"))
                .andExpect(status().isBadRequest());
    }
}
